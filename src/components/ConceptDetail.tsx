      ...
      {isFullscreen && (
        <div className="fixed inset-0 bg-black bg-opacity-98 z-[9999] flex items-center justify-center backdrop-blur-sm" style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh' }}>
          ...
          <button
            ...
            className="absolute top-24 right-6 text-white hover:text-red-400 transition-all duration-300 p-3 rounded-full hover:bg-red-500 hover:bg-opacity-20 hover:scale-110 backdrop-blur-md bg-black bg-opacity-30 border border-gray-600 hover:border-red-400 z-[10000] group"
            title="Close"
          >
